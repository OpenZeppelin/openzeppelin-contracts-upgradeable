 ...
 */
abstract contract ERC3009Upgradeable is Initializable, ERC20Upgradeable, EIP712Upgradeable, IERC3009, IERC3009Cancel {
    ...
    /// @custom:storage-location erc7201:openzeppelin.storage.ERC3009
    struct ERC3009Storage {
        mapping(address account => mapping(bytes32 nonce => bool used)) _usedNonces;
    }

    // keccak256(abi.encode(uint256(keccak256("openzeppelin.storage.ERC3009")) - 1)) & ~bytes32(uint256(0xff))
    bytes32 private constant ERC3009StorageLocation = 0x68a4e84d7293f1c72e58465b18bfb7c710b7fc94a92007a0f82a6a563831ff00;
