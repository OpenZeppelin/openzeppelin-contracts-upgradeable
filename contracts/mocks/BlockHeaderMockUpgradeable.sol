...
contract BlockHeaderMultiReadMockUpgradeable is Initializable {
    struct MultiRead {
        bytes32 parentHash;
        bytes32 ommersHash;
        address coinbase;
    ...
    function __BlockHeaderMultiReadMock_init() internal onlyInitializing {
    }

    function __BlockHeaderMultiReadMock_init_unchained() internal onlyInitializing {
    }
