...
contract MyGovernorUpgradeableWithInit is MyGovernorUpgradeable {
    constructor(IVotesUpgradeable _token, TimelockControllerUpgradeable _timelock) public payable initializer {
...
contract GovernorVoteMocksUpgradeableWithInit is GovernorVoteMocksUpgradeable {
    constructor(string memory name_, IVotesUpgradeable token_) public payable initializer {
...
contract VotesMockUpgradeableWithInit is VotesMockUpgradeable {
    constructor(string memory name) public payable initializer {
