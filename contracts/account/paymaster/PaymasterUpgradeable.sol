 ...
 */
abstract contract PaymasterUpgradeable is Initializable, IPaymaster {
    ...
    function __Paymaster_init() internal onlyInitializing {
    }

    function __Paymaster_init_unchained() internal onlyInitializing {
    }
