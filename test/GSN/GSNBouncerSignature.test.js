...
contract('GSNBouncerSignature', function ([_, signer, other]) {
  ...
  context('when trustedSigner is a zero address', function () {
    it('prohibits zero address from the initializer', async function () {
      await gsn.expectError(
        GSNBouncerSignatureMock.new(
          '0x0000000000000000000000000000000000000000'
        ),
        'Trusted Signer can not be a ZeroAddress'
      );
    });
  });
